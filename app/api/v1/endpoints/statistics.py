...
from app.services.statistics import process_statistics_batch, get_minecraft_player_stats
import logging
...
async def get_player_profile(
	...
	stats = await get_minecraft_player_stats(db, player_uuid, server_id)
